...
var SearchForm = React.createClass({displayName: "SearchForm",
    render: function() {
        return (
            React.createElement("form", {class: "search", action: "/search"}, 
                React.createElement("input", {type: "image", src: "{{ 'icon-search.png' | asset_url }}", alt: "Go", id: "go"}), 
                React.createElement("input", {type: "text", name: "q", class: "search_box", placeholder: "Search", value: "{{ search.terms }}", "x-webkit-speech": true})
            )
        );
    }
});
