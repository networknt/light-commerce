        ...
        return (
            React.createElement("div", {class: "row"}, 
                React.createElement("div", {class: "col-md-12"}, 
                    React.createElement("div", {class: "pull-left"}, 

                        React.createElement("button", {class: "btn btn-info"}, React.createElement("i", {class: "glyphicon glyphicon-edit"}), "Search")
                    ), 
                    React.createElement("div", {class: "pull-right"}, 
                        React.createElement("button", {class: "btn btn-info"}, React.createElement("i", {class: "glyphicon glyphicon-edit"}), "Checkout")
                    )
                )
            )
        );
