...
var CheckoutDone = React.createClass({displayName: "CheckoutDone",
    ...
    render: function() {
        var summaries = this.props.products.map(function(product) {
            return React.createElement(ProductSummary, {key:  product.id, product:  product })
        })

        return (
            React.createElement("div", null, 
                React.createElement("div", {className: "modal-body center"}, 
                    React.createElement("h3", null, "Your cats are on their way!"), 
                    React.createElement("h3", null, "(just kidding)"), 
                    React.createElement("h5", null, "But here are their favorite quotes on liberty:"), 
               ...
               summaries 
                ...
                React.createElement("div", {className: "modal-footer"}, 
                    React.createElement("div", {className: "pull-left"}, 
                        React.createElement("a", {href: "https://twitter.com/share", className: "twitter-share-button", "data-text": "I just bought some fake cats from the Coinbolt Cat Shop!", "data-size": "large", "data-count": "none"}, "Tweet")

                    ), 
                    React.createElement("button", {type: "button", className: "btn btn-success", onClick:  this.handleDoneClick}, 
                        "Done ", React.createElement("span", {className: "glyphicon glyphicon-play"})
                    )
                )
            )
        )
